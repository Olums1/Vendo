document.addEventListener('DOMContentLoaded', () => {
    ...
    function validateForm(form) {
        ...
        const universitySelect = form.querySelector('#university');
        const universityError = form.querySelector('#universityError');
        if (!universitySelect.value) {
            universityError.textContent = 'Please select your university';
            isValid = false;
        } else {
    ...
    if (serviceProviderForm) {
        ...
        serviceProviderForm.addEventListener('submit', function(event) {
            ...
            if (validateForm(this)) {
                ...
                alert('Service Provider Registration Successful! Redirecting to dashboard...');
